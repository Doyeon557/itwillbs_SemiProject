...
<link rel="stylesheet" type="text/css"
	href="//img.echosting.cafe24.com/editors/froala/css/froala_style_ec.min.css?vs=2301111169"
	charset="utf-8" />
<link rel="stylesheet" type="text/css"
	href="/ind-script/optimizer.php?filename=nZExDgIxDAT7KC3vsOAJPIEfOMFwJxxv5CQS_J6jggYJ0o52doulBUVof3CqjqtzIZeG4Vkot0YXh3XKKAUWN7CjX_KSQ4OOvsJCwn1SHL3Pjio_xOfUzkllUkUNupqExGZf97lWOoL9TKfPug3H9MIxKfLtP_l90BM&type=css&k=a25e2c4fd60527b98405149b31c653daef4af884&t=1658136771" />
<link rel="stylesheet" type="text/css"
	href="/ind-script/optimizer.php?filename=tdRJbkMhDAbgfV63PYeVLtprVOoJjJ8DVgAjhqi9fcmgbroMXjJ9tn4BEDQxMG2jcW3gsZLmzB9v71CGi0Jb6ClC23nbuYnP0M6Sj0eg1iDpPiKDU6w7VMb9E-mMnl_m4issk0lT4txt8KQXvuqL2dPI1EXzc2zEHx0dHDahW41rFMvR-8RilOkwB3wYYgR31dilGOmBoxVd6rwoZJV3QS8ZO1uljs5IdqP35Vf7D9dvu0CiVdhzGy37lx5VTqqdq1HDc-FZ-3_Hacx33oKWryClSParC8yDl2nM37rc4v4F&type=css&k=1d8df2ceed5362682adba3376943b91e9bf81034&t=1669093757&user=T" />
...
%>
	...
	<div class="headerSearchArea">
		<form id="searchBarForm" name="" action="/product/search.html"
			...
			<div
				class="xans-element- xans-layout xans-layout-searchheader headerSearchBox ">
				<!--
		...
		<div class="headerSearchBack"></div>
	</div>
		...
		<div id="container">
			<div id="contents">
				...
				<div
									...
									<td colspan="2">
										<div class="detail">
											<div class="fr-view fr-view-article">
												<textarea rows="200" cols="250" readonly><%=dto.getNotice_content() %></textarea>
											</div>
										</div>
					...
					if(dto.getManager_Num().equals(id)){
						%>
					<div align="center">	
<%-- 					<input value="글수정" class="btnEmFix" onclick="location.href='./BoardUpdateForm.bo?num=<%=dto.getNotice_num()%>'"> --%>
					<input type="button" value="글수정" class="btnEmFix" onclick="location.href='./BoardUpdateForm.bo?num=<%=dto.getNotice_num()%>'">
					<input value="글삭제" class="btnEmFix" onclick="location.href='./BoardDelete.bo?num=<%=dto.getNotice_num()%>'">
					<input type="button" value="글목록" class="btnEmFix" onclick="location.href='./BoardList.bo'">
					</div>
						<%
					} else {
					%>
					...
					%>
<!-- 					<span class="gLeft">                 <a href="/board/notice/1/" class="btnNormalFix sizeS">목록</a> -->
<!-- 					</span> -->
<!-- 					<div align="center"> -->
<!-- 					<input type="button" value="글목록" class="btnEmFix" onclick="location.href='./BoardList.bo'"> -->
<!-- 					</div> -->
	...
	<script type="text/javascript"
		src="//t1.daumcdn.net/adfit/static/kp.js" charset="utf-8"></script>
	<script type="text/javascript"
		src="//developers.kakao.com/sdk/js/kakao.min.js" charset="utf-8"></script>
	<script type="text/javascript"
		src="/ind-script/i18n.php?lang=ko_KR&domain=front&v=2301111169"
		charset="utf-8"></script>
	<script
		src="/ind-script/optimizer.php?filename=zVhNc9s2EL1bvPZ3sGlmOr3act1kak80tjM5L8EluSa-ig_Lyq_vkpJbq4ooEpRneiElEO9hsXjYXSBvjML8wy8urxwoXBvX5g69iU5g_uRz-vCbzp78T_lQv0gWRJs__RXRbXavj9mv2c8TkfgS0GmQfteQCWNawrks0cmkKWQoskonQ0ES-DQ0fw3G_Wfi1pma8XvLU0LAQNxBcS8dchR3_Y9vFJrH79cQIFOkJ_BIKhiFj_z7NMpbRzpUI-iNiJ1ZN8appdHBGSnRncatZPSX1l45KusR9sRA8nSvypneUxfeSEYYfRGMvZCk8aIArcfYtaUQRimjx_Z-Ac3bSbM2rcMwfpQeF1BZyevyYxBYm9-ZgiTm92_wW_sGvHIEp0wZucmvyU4bsIpadA7t-pVRhEwdFfFYhgEjWKr51-3ueUsh4ftGGigngVQM0I37pfDono8tzhGwNXJTkRwtvRIriDJ0LvAKXLgaUF3X6aExdm_Am57mT2jB5G33XNELyqFdMkCz7FXydVAkx6CsyNq4zS35MBl8jxU61AKX0XXvzcqRmB3ri5p60P8j85QcRrVnXfm5TAiedD2XRWGAsksKUxfLIzjRTNoVAapqc5h9ThptZayJQ94z50-21bhX4_9pSMqsh7Sdd3TpD-mZwfKS4fuN0KC0-O7zaECXB2n2nANwoCRe43fj56AazuYmaQRwtmnN6TD9rwVH98mVAVfu6Z1bs6JrTQNFIdKABU-sTYM6tMaFVOyxFPvWk5cxNA8Pt2lDdPULF42nR1Ggoe5q4Ohx4ahupmJKB_VEyGulMlDebLu_ndsaebXqSWH0NTvmniPzwh7myEl4sfu3qLgShzDXknPRjCvcm6Ak64ECoZ_kdvAbLbbPZJxCVQwVaSfgX1yJTuiQTHAFvsUwn2FAQaM5VrviPJVlaSIn2DlzueODA9Tp87jmyOcpffxv5JvhqncEgTBxhgscCpwBv-_hjyaAXM6yo1d2uqBQY0VzRX0Lmxk2_OGgTJcSpzjDMZBET8P18zpd1XwqpJWx0aZT8GGsxd0Gnbewe1SzxH5LzyhJtxOz5YHKPlF3LbY5g153TI9QnIXnc0A1y0M92TWfzkh-1pVJj6wSSEEhcYZFFkLjjMTFiDL41MIfvYc5ArYJmWWbmRdcWNE0ffl1xkcCORQ5ft-doPcvqfojMX_2wpENE9HdTUt-2R21LYr-PrCCoYz8Q5K9AGTtcuRNpDMx4A29cM-_AQ&type=js&k=8d7b75af2b4e93d0fe6ac7bb48c90a0b8700ac64&t=1672100518"></script>
	<script
		src="/ind-script/optimizer.php?filename=rc_LEcIwDATQAsyVOjThAIVQgSNrbCWWZSwbJt3zGTpIbnt6uwtJhYDQDaNmEH1DLYVulyvUMWdGl7pksEAukHEsYCuXaYLFQDSMTJD9pqMD-k5R23Za7AyHqTJyZ0ta74lr5RJ38X909sb47fqFvYNRRbQce_sxGFf3ZHp93Dc&type=js&k=6230574a1cd95480b583d3f2c14ea45e65df8418&t=1659690024&user=T"></script>

							...
							<div class="EndTopTitle_title_box__5AWVA">
								<h2>
									<button class="EndTopTitle_title__l_GCS"
										style="cursor: default">공지사항 작성</button>
								</h2>
							</div>
						</div>
							...
							<form action="./BoardWritePro.bo" method="post">
								<fieldset class="EndSuggest_field_set__1aLaM">
									...
									<div class="EndSuggest_field_box__2Rb3-">
										<dl>
											<dt class="EndSuggest_essential__iYBLH">작성자</dt>
											<dd>
												<div
													class="EndSuggest_input_box__3boVM EndSuggest_mail__1Ihy-">
													<input type="text" name="Manager_Num" value="<%=id %>" readonly required id="title" />
<!-- 													<input type="text" name="Notice_title" required id="title" /> -->
												</div>
											</dd>
										</dl>
									</div>
									...
									<div class="EndSuggest_field_box__2Rb3-">
										<dl>
											...
											<dd>
												...
												<textarea rows="12" cols="50" name="Notice_content" required></textarea>
...
<!-- 											<input type="submit" value="작성" class="CommonBtn_common_btn__Kg8Jd"> -->
<!-- 											<input type="reset" value="취소" class="CommonBtn_common_btn__Kg8Jd" onclick="location.href='./QnaBoardList.ao'"> -->
<!-- 										</div> -->
<!-- 									</div> -->
									
									<div align="right">
										<input type="submit" class="btnEmFix" value="작성">
										<input type="reset" class="btnEmFix" value="취소" onclick="location.href='./BoardList.bo'">
									</div>
...
<!-- 				<tr> -->
<!-- 					<td>작성자</td> -->
<%-- 					<td><input type="text" name="Manager_Num" value="<%=id %>" readonly required id="title" /> --%>
<!-- 					</td> -->
<!-- 				</tr> -->
<!-- 				<tr> -->
<!-- 					<td>제목</td> -->
...
<!-- 							name="Notice_content" required></textarea></td> -->
<!-- 				</tr> -->
<!-- 				<tr> -->

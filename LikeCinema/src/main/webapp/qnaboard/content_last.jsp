					...
					<div class="inner">
							...
							<div class="EndTopTitle_title_box__5AWVA">
								<h3>
									<button class="EndTopTitle_title__l_GCS"
										style="cursor: default">1:1문의</button>
								</h3>
							</div>
						</div>
						...
						<div class="field_wrap" style="display: block">
								<fieldset class="EndSuggest_field_set__1aLaM">
										...
										<dl>
											...
											<dd>
												<div
													...
													<input type="text" value="<%=dto.getQna_num() %>" "readonly required id="title"/ >
												</div>
											</dd>
										</dl>
									</div>
									...
									<div class="EndSuggest_field_box__2Rb3-">
										<dl>
											<dt class="EndSuggest_essential__iYBLH">글작성자</dt>
											<dd>
												<div class="EndSuggest_input_box__3boVM">
													<input type="text" value="<%=dto.getUser_ID() %>" "readonly required id="title"/ >
												</div>
											</dd>
										</dl>
									</div>
									...
									<div class="EndSuggest_field_box__2Rb3-">
										<dl>
											<dt class="EndSuggest_essential__iYBLH">글제목</dt>
											<dd>
												<div class="EndSuggest_input_box__3boVM">
													<input type="text" value="<%=dto.getQna_title() %>" "readonly required id="title"/ >
												</div>
											</dd>
										</dl>
									</div>
									...
									<div class="EndSuggest_field_box__2Rb3-">
										<dl>
											...
											<dd>
												<div class="EndSuggest_input_box__3boVM">
													<textarea rows="12" cols="50" readonly><%=dto.getQna_content() %></textarea>
												</div>
											</dd>
										</dl>
									</div>
...
<!-- 													<input type="button" value="문의글수정" class="CommonBtn_common_btn__Kg8Jd"  -->
<%-- 														onclick = "location.href='./QnaBoardUpdateForm.ao?Qna_num=<%=dto.getQna_num() %>'"> --%>
<!-- 													<input type="button" value="문의글삭제" class="CommonBtn_common_btn__Kg8Jd"   -->
...
<!-- 													<div class="CommonBtn_common_btn_wrap__20kqy"> -->
<!-- 													<div class="CommonBtn_common_btn_box__3iWhO"> -->
<!-- 													<input type="button" value="글목록" class="CommonBtn_common_btn__Kg8Jd" onclick="location.href='./QnaBoardList.ao?'"> -->
<!-- 													</div> -->

													<!-- todo 수정하기  -->
<!-- 													<div align="right"> -->
<!-- 															<input type="button" class="btnEmFix" value="글목록"  -->
<!-- 																onclick = "location.href='./QnaBoardList.ao?'"> -->

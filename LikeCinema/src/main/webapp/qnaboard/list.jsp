...
<%@page import="com.itwillbs.qnaBoard.action.QnaBoardList"%>
...
<%
List<qnaBoardDTO> boardList=(List<qnaBoardDTO>)request.getAttribute("boardList");
		...
		<div class="ec-base-table typeList gBorder">
			<table border="1" summary="">
				...
				<tr>
					...
					<td><a
						href="./QnaBoardContent.ao?Qna_num=<%=dto.getQna_num()%>"> <%=dto.getQna_title()%></a></td>
			...
			<form>
				...
				<!--   <input type="submit" value="글쓰기" id="write" class="btnSubmitFix sizeS displaynone" onclick="location.href='./QnaBoardWriteForm.ao'" onsubmit="return write()"> -->
			</form>
			...
			<div
				...
				<ol>
					...
					%> 
					<a href="./QnaBoardList.ao?pageNum=<%=startPage - pageBlock%>"
						class="this">Prev</a>
...
<%-- 					<a href="./QnaBoardList.ao?pageNum=<%=i%>"><%=i %></a> --%>
					<li class="xans-record-"><a href="./QnaBoardList.ao?pageNum=<%=i %>"
						class="this"><%=i %></a></li>
					<%
					}

...
<head>
<meta charset="UTF-8">
<title>qna/replyupdateForm.jsp</title>
</head>
<body>
<%
...
<div align=center>
	<table width=800>
		<tr>
			<td align="center" height=25 bgcolor="lightgray">1:1문의 답변수정</td>
		</tr>
	</table>
<br>
	...
	<!-- 1.11수정 -->
	<intpu type="hidden" value="<%=dto.getQna_num()%>">
				...
				<td>
					<table align=center>
						...
						<tr>
							...
							<input type="reset" value="취소" onclick="location.href='./QnaBoardList.bo'"></td>
						</tr>
					</table>	
				</td>
			</tr>

			...
			<div id="contents">
				<div
					...
					<div
						...
						<div class="titleArea w1200">
							<h2>
								<font color="#000000">QNA</font>
							</h2>
						</div>
					</div>
...
<%-- 												<textarea rows="50" cols="100" readonly><%=dto.getQna_content()%></textarea> --%>
											</div>
										</div>
					...
					%>
					<div align="center">
						<input type="button" class="btnEmFix" value="글수정"
							onclick="location.href='./QnaBoardUpdateForm.ao?Qna_num=<%=dto.getQna_num()%>'">
						<input type="button" class="btnEmFix" value="글삭제"
					...
					<div align="center">
						<input type="button" class="btnEmFix" value="글삭제"
							onclick="location.href='./QnareplyBoardDelete.ao?Qna_num=<%=dto.getQna_num()%>'">
						<input type="button" class="btnEmFix" value="답변하기"

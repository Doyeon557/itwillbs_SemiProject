							...
							<div class="EndTopTitle_title_box__5AWVA">
								<h2>
									<button class="EndTopTitle_title__l_GCS"
										style="cursor: default">1:1문의 답변하기</button>
								</h2>
							</div>
						</div>
							...
							<input type="hidden" name="Qna_num" value="<%=qna_num %>">
								...
								<fieldset class="EndSuggest_field_set__1aLaM">
									...
									<div class="EndSuggest_field_box__2Rb3-">
										<dl>
											<dt class="EndSuggest_essential__iYBLH">글쓴이</dt>
											<dd>
												<div
...
<!-- 													<input type="text" class="input_text" /> -->
													<input type="text" name="title" value="고객님, 문의 답변 드립니다.">
												</div>
											</dd>
										</dl>
									</div>
									<div class="EndSuggest_field_box__2Rb3-">
										<dl>
											...
											<dd>
												...
												<textarea name="content" id="content" rows="10" cols="50" wrap="hard">
												</textarea>
<!-- 													<textarea maxLength="1000"></textarea> -->
									...
									<div align="right">
										<input type="submit" class="btnEmFix" value="답변하기" onclick="if(!confirm('답변하시겠습니까?')) {return false;}">
										<input type="reset" class="btnEmFix" value="취소" onclick="location.href='./QnaBoardList.ao'">
									</div>
